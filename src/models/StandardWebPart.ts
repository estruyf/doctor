 ...
 * surface that a patch release may move. These 27 ids are fixed by SharePoint.
 *
 * `NewsReel` deliberately appears twice — SharePoint ships two web parts under
 * that name and the first one is the one that gets used, as in the CLI.
 */
export const STANDARD_WEB_PARTS: { name: string; id: string }[] = [
...
/** The built-in Markdown/Text web part every doctor page has always used */
export const MARKDOWN_WEB_PART_ID = "1ef5ed11-ce7b-44be-bc5e-4abd55101d16";
