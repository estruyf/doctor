...
> **Info**: Check out the [multilingual](../../content/multilingual) section to see how the pages themselves are linked to each other.
...
> **Important**: The `theme` is only applied when you pass the [`--applyTheme`](../cli-options/#publish-command-specific-options) flag to the publish command.
