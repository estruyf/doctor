...
2. Add the **Sites.FullControl.All** application permission from SharePoint, and grant admin consent for your tenant. To scope the app to a single site instead, use **Sites.Selected** and grant it rights on that site — see [scoping the app to a single site](./certificate-authentication/#scoping-the-app-to-a-single-site).
